...
# FONTS
PKGS_FONTS="ttf-jetbrains-mono-nerd ttf-nerd-fonts-symbols ttf-nerd-fonts-symbols-mono ttf-font-awesome noto-fonts-emoji ttf-material-design-icons-desktop-git"
# THEME & APPEARANCE
...
chmod +x "$SYSTEM_SCRIPT_DIR/utils/brightness-control.sh"
